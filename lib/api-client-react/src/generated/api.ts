...
export const getGetCheckoutSessionQueryOptions = <TData = Awaited<ReturnType<typeof getCheckoutSession>>, TError = ErrorType<void>>(sessionId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCheckoutSession>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetCheckoutSessionQueryError = ErrorType<void>
...
export function useGetCheckoutSession<TData = Awaited<ReturnType<typeof getCheckoutSession>>, TError = ErrorType<void>>(
